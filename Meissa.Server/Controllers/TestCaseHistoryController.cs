...
public class TestCaseHistoryController : Controller
{
    ...
    public async Task<IActionResult> GetTestCaseHistory([FromBody] int id)
    {
        try
        {
            var testCaseHistory = await _meissaRepository.GetByIdAsync<TestCaseHistory>(id).ConfigureAwait(false);
    ...
    public async Task<IActionResult> GetTestCaseHistorys()
    {
        try
        {
            var testCaseHistorys = await _meissaRepository.GetAllQueryWithRefreshAsync<TestCaseHistory>().ConfigureAwait(false);
    ...
    public async Task<IActionResult> CreateTestCaseHistoryAsync([FromBody] TestCaseHistoryDto testCaseHistoryDto)
    {
        ...
        var result = await _meissaRepository.InsertWithSaveAsync(testCaseHistory).ConfigureAwait(false);
    ...
    public async Task<IActionResult> UpdateTestCaseHistoryAsync([FromBody] KeyValuePair<int, TestCaseHistoryDto> updateObject)
    {
        ...
        var entityToBeUpdated = await _meissaRepository.GetByIdAsync<TestCaseHistory>(updateObject.Key).ConfigureAwait(false);
    ...
    {
        var entityToBeRemoved = await _meissaRepository.GetByIdAsync<TestCaseHistory>(id).ConfigureAwait(false);
